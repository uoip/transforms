...
class VOCDetection(object):   # torch.utils.data.Dataset
    def __init__(self, root, image_set, keep_difficult=False, transform=None, 
...
class VOCSegmentation(object):   # torch.utils.data.Dataset
